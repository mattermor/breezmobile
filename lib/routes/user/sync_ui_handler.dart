...
class TransparentRouteLoader extends StatefulWidget {
  ...
  const TransparentRouteLoader({Key key, this.message, this.opacity = 0.5, this.value, this.onClose}) : super(key: key);
                      ...
                      children: <Widget>[
                        ...
                        Center(
                            child: Text("${(widget.value * 100).round().toString()}%",
                                textAlign: TextAlign.center, style: TextStyle(fontSize: 36.0, color: Colors.white))),
                      ],
                    ),
                    Padding(
