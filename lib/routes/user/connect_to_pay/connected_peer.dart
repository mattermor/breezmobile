...
class ConnectedPeer extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    String imagURL = _renderPayer ? _paymentSessionData.payerData.imageURL : _paymentSessionData.payeeData.imageURL;
    bool showShare = !_renderPayer && !_me && !_paymentSessionData.invitationSent && imagURL == null;
