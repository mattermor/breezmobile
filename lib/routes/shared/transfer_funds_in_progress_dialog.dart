...
Widget buildTransferFundsInProgressDialog(BuildContext context, Stream<AccountModel> accountStream) {
...
class _TransferFundsInProgressDialog extends StatefulWidget {
  ...
  const _TransferFundsInProgressDialog({Key key, this.accountStream}) : super(key: key);
  @override
