...
class OnlineStatusUpdater {
  ...
  void startStatusUpdates(
      String localKey, Function(PeerStatus) onLocalStatusChanged, String remoteKey, Function(PeerStatus) onRemoteStatusChanged) {
  ...
  Future stopStatusUpdates() {
    ...
    return Future.wait([_onRemoteConnectSubscription.cancel(), _onLocalConnectSubscription.cancel()]).then((_) {
