...
class FullScreenLoader extends StatelessWidget {
  ...
  const FullScreenLoader({Key key, this.message, this.opacity = 0.5, this.value, this.progressColor, this.bgColor = Colors.black, this.onClose})
      : super(key: key);
