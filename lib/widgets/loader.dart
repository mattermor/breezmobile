...
TransparentPageRoute createLoaderRoute(BuildContext context, {String message, double opacity = 0.5, Future action}) {
...
class FullScreenLoader extends StatelessWidget {
  ...
  const FullScreenLoader(
      {Key key, this.message, this.opacity = 0.5, this.value, this.progressColor, this.bgColor = Colors.black, this.onClose})
      : super(key: key);
          ...
          Positioned(
            ...
            child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Loader(value: this.value, label: this.message, color: this.progressColor),
                    Padding(
...
class TransparentRouteLoader extends StatefulWidget {
  ...
  const TransparentRouteLoader({Key key, this.message, this.opacity = 0.5, this.action}) : super(key: key);
